...
<main class="main-class">
    ...
    <div class="donor-container" v-if=" status === 'Loaded' ">
        ...
        <button class="donor-button" @click="showDonationForm()">Become Donor</button>
        <hr>
        <div class="search-details-container">
            <form class="search-donor-details" >
                ...
                <div class="select-city">
                    ...
                    <select id="search-by-city" class="select-city-name" v-model="parameters.city">
                        <option value=""></option>
                ...
                <table class="donor-table">
                    ...
                    <tbody>
                        <tr v-for="donor,index in allDonors" :key="donor._id"  >
                            ...
                            <td class="donor-data">{{ donor.location.city }} ({{ donor.location.state }})</td>
            ...
            <form class="donor-form" @submit.prevent="becomeDonor">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-text text-muted" v-if="$v.donorForm.bloodGroup.$error">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        >
                        <div class="form-text text-muted" v-if="$v.donorForm.email.$error">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.donorForm.contactNumber),
                                    'is-valid' : shouldAppendValidClass( $v.donorForm.contactNumber )
                            }"
                        >
                        <div class="form-text text-muted" v-if="$v.donorForm.contactNumber.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                         ...
                         <div class="form-text text-muted" v-if="$v.donorForm.state.$error">
                            <small>state is required</small>
                        </div>
                    </div>               
                    <button type="submit" class="btn btn-secondary px-5 submit-button my-btn">Submit</button>
                    <button type="submit" class="btn btn-secondary px-5 submit-button my-btn" @click="hideForm">Cancel</button>
                </div>
            </form>
            </div>
        </div>
