<template>
    ...
    <form class="container col-3 py-2 rounded form-class" @submit.prevent="login">
            <h1>Login</h1>
            <hr/>
            ...
            <div class="form-text text-muted mx-1" v-if="$v.form.password.$error">
                ...
                <div v-if="!$v.form.password.containsUppercase">
                    <small>The password must have atleast 1 uppercase character [A-Z]</small>
                </div>
                ...
                <div v-if="!$v.form.password.containsSpecial">
                    <small>The password must have atleast 1 special character form { #?!@$%^&*- }</small>
                </div>
            </div>
        </div>
