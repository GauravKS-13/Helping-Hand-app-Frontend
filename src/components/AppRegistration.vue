        ...
        ="userRegister()">
            ...
            <div class="user-email">
                ...
                <div class="email-info">
                    <small id="emailHelp" class="email-help">We'll never share your email with anyone else.</small> 
                </div>       
            </div>
            ...
            <div class="user-password">
                ...
                <div v-else-if="!$v.form.password.containsUppercase">
                    <small>The password must have atleast 1 uppercase character</small>
                </div>
                <div v-else-if="!$v.form.password.containsLowercase">
                    <small>The password must have atleast 1 lowercase character</small>
                </div>
            ...
            <p>Already have an account? <router-link :to = "{ name: 'login-page' }" class="router-link">login here</router-link></p>
            </div>
