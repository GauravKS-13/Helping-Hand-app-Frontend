  ...
  <main class="main-class">
       ...
       <div class="request-menu">
           <div class="menu-add-request">
            <router-link :to ="{ name:  'user-request'}" class="request-menu-add-request" style="text-decoration:none;">Make Request</router-link>
            </div>
            <div class="menu-find-request">
            <router-link :to ="{ name:  'search-request'}" class="request-menu-search" style="text-decoration:none;">Find Request</router-link>  
            </div> 
        </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.patientName),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.patientName )
                                }"
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.patientName.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.age.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                            <div class="form-text text-muted" v-if="$v.requestForm.gender.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="bloodGroup" 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.bloodGroup),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.bloodGroup )
                                }"
                        >   
                            <option selected>Choose Blood Group</option>
                            <option 
                                v-for="bloodGroup in allBloodGroups" :key="bloodGroup" 
                                :value="bloodGroup"
                            > 
                            {{ bloodGroup }}
                            </option>
                        </select>
                        <div class="form-text text-muted" v-if="$v.requestForm.bloodGroup.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.units.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.date.$error">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" 
                            class="form-control" 
                            id="hospital-name" 
                            placeholder="Enter the Hospital Name" v-model="requestForm.hospitalName"
                            @blur="$v.requestForm.hospitalName.$touch()"
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.hospitalName),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.hospitalName )
                                    }"
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.hospitalName.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.location.city),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.location.city )
                            }"
                        >
                            <option selected>Choose City</option>
                            <option v-for="city in cities" :key="city">{{ city }}</option>
                        </select>
                        <div class="form-text text-muted" v-if="$v.requestForm.location.city.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.location.state ),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.location.state )
                            }"
                        >
                            <option selected>Choose State</option>
                            <option>Rajasthan</option>
                        </select>
                         <div class="form-text text-muted" v-if="$v.requestForm.location.state.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.email.$error">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input 
                            ...
                            class="form-control" 
                            id="contact" 
                            placeholder="Enter the Contact Number" v-model="requestForm.contact"
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.contact),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.contact )
                                    }"
                        >
                        <div class="form-text text-muted" v-if="$v.requestForm.contact.$error">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select 
                            ...
                            :class="{
                                    'is-invalid' : shouldAppendErrorClass( $v.requestForm.urgerntRequirment),
                                    'is-valid' : shouldAppendValidClass( $v.requestForm.urgerntRequirment )
                            }"
                        >
                         ...
                         <div class="form-text text-muted" v-if="$v.requestForm.urgerntRequirment.$error">
                            <small>urgent requirment is required</small>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-secondary px-5 submit-button">Submit</button>
                </div>
            </form>
            </div>
        </div>
...
.request-menu-search,.request-menu-add-request {
    color: #525456;
    border-radius: 0.1em;
}
